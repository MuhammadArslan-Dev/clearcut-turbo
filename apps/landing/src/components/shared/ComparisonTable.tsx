...
const TABLE: Record<Locale, { comparisonTitle: string; coachingTitle: string; rows: ComparisonRow[] }> = {
  ...
  mr: {
    ...
    coachingTitle: "कोचिंग सेंटर",
    rows: [
      { label: <B>परवडणारे शुल्क</B>, coaching: "फी ₹20,000+ (प्रति कोर्स)", app: <><B>₹99</B> (पूर्ण अ‍ॅक्सेस)</> },
      { label: <B>सर्व विषय समाविष्ट</B>, coaching: "मर्यादित विषय पर्याय", app: <><B>सर्व विषय</B> एकाच ठिकाणी</> },
      { label: <B>अमर्यादित सराव टेस्ट</B>, coaching: "मर्यादित टेस्ट; बहुतेक क्लासमध्ये", app: <>मिनी टेस्ट + <B>सेक्शनल टेस्ट</B> + PYQs</> },
      { label: <B>रिफंड गॅरंटी</B>, coaching: "रिफंड धोरण नाही", app: <>कोर्स पूर्ण केल्यानंतरही उत्तीर्ण न झाल्यास <B>पूर्ण रिफंड</B></> },
      { label: <B>परीक्षेसाठी सज्ज</B>, coaching: "बहुतांश थिअरी; शिकवण्यावर जास्त भर", app: <>PYQs आणि <B>परीक्षा पॅटर्न</B>वर भर</> },
      { label: <B>सबस्क्रिप्शन कालावधी</B>, coaching: "फक्त कोर्सच्या कालावधीपुरते", app: <><B>1 वर्षाचा</B> पूर्ण अ‍ॅक्सेस</> },
      { label: <B>अतिरिक्त शुल्क?</B>, coaching: "नोट्स आणि अभ्यास साहित्यासाठी वेगळे पैसे", app: <><B>मोफत नोट्स</B> आणि अभ्यास साहित्य!</> },
    ],
  },
};
