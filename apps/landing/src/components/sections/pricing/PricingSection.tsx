...
const PRICING_COPY: Record<Locale, {
  ...
  mr: {
    headingLine1: "तुमची परीक्षा उत्तीर्ण होण्यासाठी",
    headingLine2: "सर्व काही इथे आहे",
    subtitle: "स्मार्ट तयारी. उत्तम सराव. जास्त गुण.",
    planTitle: "फुल अ‍ॅक्सेस प्लान",
    priceNote: "1 महिन्याचे सबस्क्रिप्शन सुरुवात",
    buttonText: "मोफत सुरू करा",
    badgeText: "सर्वाधिक लोकप्रिय",
    trustText: "कोणतेही पेमेंट आवश्यक नाही · कधीही रद्द करा",
    featureLabels: ["अमर्यादित अ‍ॅक्सेस", "हजारोंचा विश्वास", "तुमच्या गतीने अभ्यास करा"],
    points: [
      { title: "सर्व विषय समाविष्ट", description: "तुमच्या परीक्षेचे सर्व विषय एकाच ठिकाणी अभ्यासा." },
      { title: "अमर्यादित सराव टेस्ट", description: "मिनी टेस्ट, सेक्शनल टेस्ट आणि PYQs सह सराव करा, आणि तुमचे गुण वाढवा." },
      { title: "तुमची योजना निवडा", description: "6 किंवा 15 महिन्यांसाठी अमर्यादित अ‍ॅक्सेस. तुमच्या गतीने अभ्यास करा, परीक्षा कधीही असो." },
      { title: "पैसे भरण्यापूर्वी 3 दिवसांची मोफत ट्रायल", description: "विनामूल्य तयारी सुरू करा." },
    ],
  },
};
