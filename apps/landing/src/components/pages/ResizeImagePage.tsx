...
/**
 * Server Component shell — mirrors StartPage's pattern: only the
 * interactive tool (canvas work, drag/drop, file state) ships as client JS.
 */
  ...
  return (
    <div>
      ...
      <div className="px-4 md:px-6 py-10 md:py-14">
        <div className="max-w-[620px] mx-auto text-center flex flex-col items-center gap-4 mb-10">
