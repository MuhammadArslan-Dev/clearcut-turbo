...
// between the vertical desktop rail and the horizontal mobile row.
import { useState } from "react";

const iconClass =
  "flex h-9 w-9 items-center justify-center rounded-full border border-slate-200 text-slate-500 transition-colors hover:border-blue-300 hover:bg-blue-50 hover:text-blue-600";
...
export default function ArticleShare({
  ...
  return (
    <div
      className={
        vertical ? "flex flex-col items-center gap-2" : "flex flex-wrap items-center gap-2"
      }
    >
      {!vertical ? (
