...
> = {
  ...
  mr: {
    eyebrow: "Clear Cutoff ॲप",
    title: "परीक्षेची तयारी आता तुमच्या खिशात",
    lead: "CTET, HTET, UPTET सारख्या परीक्षांसाठी मोफत मॉक टेस्ट, लाइव्ह क्लासेस आणि अभ्यास साहित्य — तुमच्या फोनवर.",
    cta: "Google Play वर मिळवा",
    ctaSub: "मोफत डाउनलोड · Android",
    features: ["मोफत मॉक टेस्ट", "लाइव्ह आणि रेकॉर्डेड क्लासेस", "दैनंदिन सराव प्रश्न"],
  },
};
