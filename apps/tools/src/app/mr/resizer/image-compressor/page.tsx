...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://clearcutoff.in/mr/tools/resizer/image-compressor",
    languages: {
      en: "https://clearcutoff.in/tools/resizer/image-compressor",
      hi: "https://clearcutoff.in/hi/tools/resizer/image-compressor",
      mr: "https://clearcutoff.in/mr/tools/resizer/image-compressor",
    },
  },
  openGraph: {
    title: TITLE,
    description: DESCRIPTION,
    url: "https://clearcutoff.in/mr/tools/resizer/image-compressor",
