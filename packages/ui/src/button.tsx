...
const Spinner = () => (
  // h-5/w-5 (up from h-4/w-4): every button size's own min-height (28px at
  // the smallest) already has enough padding headroom to absorb this without
  // growing. `ml-[3px]` is on top of the button's own `gap-1` — extra
  // breathing room between the label and the spinner specifically, without
  // touching the gap other icon slots (leftIcon/rightIcon) use.
  <svg className="h-5 w-5 shrink-0 ml-[3px] animate-spin" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
